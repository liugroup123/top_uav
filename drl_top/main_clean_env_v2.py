...
# 获取当前文件目录路径
model_dir = os.path.join(current_dir, './output_clean_env/models/test2_7_13')  # 模型保存文件夹
video_dir = os.path.join(current_dir, './output_clean_env/videos/test2_7_13')  # 视频保存文件夹
runs_dir = os.path.join(current_dir, './output_clean_env/runs/test2_7_13')  # TensorBoard 日志文件
