...
uav_env_path = os.path.join(parent_dir, 'uav_top_env', 'uav_env_clean_v4.py')
spec = importlib.util.spec_from_file_location("uav_env_clean_v4", uav_env_path)
...
# 获取当前文件目录路径
model_dir = os.path.join(current_dir, './output_clean_env/models/env_v4')  # 模型保存文件夹
video_dir = os.path.join(current_dir, './output_clean_env/videos/env_v4')  # 视频保存文件夹
runs_dir = os.path.join(current_dir, './output_clean_env/runs/env_v4')  # TensorBoard 日志文件
